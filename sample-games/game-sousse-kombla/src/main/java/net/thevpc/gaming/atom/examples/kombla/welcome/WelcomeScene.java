 ...
 */
@AtomScene(id = "welcome", sceneEngine = "welcome", title = "Kombla", tileWidth = 600, tileHeight = 400)
public class WelcomeScene extends DefaultScene {
        ...
        /**
         * Server Address Text Field used for specifying Remote Server address on
         * Clients
         */
        ...
        /**
         * Server Port Text Field used for specifying Remote Server port on Clients and
         * listening port for Server
         */
        private final STextField serverPort = new STextField("serverPort", "12345");
        ...
        public void onInstall() {
                ...
                addLayer(new FillScreenGradientLayer(new Color(200, 230, 126), Color.DARK_GRAY,
                ...
                // each value defines the "Object Value" to consider and the "Object Label" to
                // show
                ...
                // define selected value of the list to be the virst value aka
                // AppRole.LOCAL_GAME
                ...
                ViewBox r2 = new ViewBox(vp.getX(), vp.getY() + vp.getHeight() * 2 / 3, vp.getWidth(),
                                vp.getHeight() / 3);
                // define component position on screen in pixels
                start.setBounds(r2);
                // configure style (colors, fonts, ...)
